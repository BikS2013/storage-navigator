...
| `api` | OIDC bearer JWT or anonymous | ✓ | ✓ | — (Plan 008) | Talks to a deployed Storage Navigator API |
...
- **🔗 Connect to Storage Navigator API** — friendly name + API base URL; if the API has auth on, OIDC login flow opens automatically
